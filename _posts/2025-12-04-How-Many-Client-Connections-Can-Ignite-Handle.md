...
Let's see how many concurrent client connections a single Ignite 3 node can handle. 
...
To establish the connections, I'm using the [Ignite.NET client](https://www.nuget.org/packages/Apache.Ignite/3.1.0) in a simple console app 
that connects to the server in a loop and keeps the connections open. After the loop we verify that all connections are still alive.

The full program is on GitHub: https://gist.github.com/ptupitsyn/86056d4143811ba5dde6b2d1704fa948
